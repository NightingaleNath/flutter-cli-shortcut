...
function activate(context) {
    ...
    let flutterCreateCodeLyticalRiverpod = vscode.commands.registerCommand("flutter-cli-shortcut.flutterCreateCodeLyticalRiverpod", async () => {
        const projectName = await vscode.window.showInputBox({
            prompt: "Enter the name of the new Flutter project (e.g., methodist_ndwom)",
            placeHolder: "e.g., methodist_ndwom",
        });
